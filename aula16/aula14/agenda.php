...
<body class="container">
	...
	<h3 class="text-primary">Agenda de <b><?php echo $_SESSION['usuario']; ?></b> - 
	...
	{
		$eventos = array(); // prepara um array 
		...
		while ($eventos = mysqli_fetch_assoc($resultado)) 
		{
			...
			{
				// ao mostrar os valores da linha atual do array 'eventos',
			...
			echo '<td class="text-center"><a href="editar.php?id_evento='.$id_evento.'" class="btn btn-warning">Editar</a></td>';

			echo '<td class="text-center"><a href="deletar.php?id_evento='.$id_evento.'" class="btn btn-danger">Deletar</a></td>';
